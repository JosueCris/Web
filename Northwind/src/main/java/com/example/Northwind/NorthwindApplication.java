...
public class NorthwindApplication {
	...
	private PasswordEncoder passwordEncoder;	//	Quedamos pendiente con la anotacion @Autowired

	//	Este metodo es para poder hacer la encriptacion de las contraseñas del usuario.
	@Bean
